...
const DemoSection = () => {
    return (<section id="demo" className="py-16 bg-gradient-to-b from-white to-blue-50 dark:from-slate-900 dark:to-slate-800">
    ...
    // This method is called when the extension is activated</span>{'\n'}
    ...
    // Create and initialize the main extension class</span>{'\n'}
    ...
    // Add to subscriptions to ensure proper disposal</span>{'\n'}
    ...
    // Show initial activation message</span>{'\n'}
    ...
    // This method is called when the extension is deactivated</span>{'\n'}
          ...
          <div className="mt-8 text-center">
            ...
            <a href="#installation" className="inline-flex items-center px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition-colors">
