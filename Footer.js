        ...
        <div className="flex flex-col md:flex-row justify-between">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-slate-400">
                <li>
                  <a href="https://github.com/ai-summarizer/vscode-extension" target="_blank" rel="noopener noreferrer" className="hover:text-blue-400 transition-colors flex items-center">
                ...
                <li>
                  <a href="https://twitter.com/ai_summarizer" target="_blank" rel="noopener noreferrer" className="hover:text-blue-400 transition-colors flex items-center">
                    <svg className="h-4 w-4 mr-2" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                ...
                <li>
                  <a href="mailto:support@ai-summarizer.com" className="hover:text-blue-400 transition-colors flex items-center">
                    <svg className="h-4 w-4 mr-2" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <div className="col-span-2 md:col-span-1">
              ...
              <form className="flex">
                <input type="email" placeholder="Your email" className="px-4 py-2 rounded-l-lg focus:outline-none focus:ring-2 focus:ring-blue-500 flex-grow bg-slate-800 text-white border border-slate-700"/>
                <button type="submit" className="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-r-lg transition-colors">
                  Subscribe
                </button>
              </form>
            </div>
